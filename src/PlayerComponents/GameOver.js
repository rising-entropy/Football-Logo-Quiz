const GameOver = (props) => {
    ...
    if(parseInt(props.scorePercent) === 100)
    {
        whatToShow = <>
        <h3>Game Over</h3>
        <h4>Score: {props.questionCount}</h4>
    ...
    else if(parseInt(props.scorePercent) >=80 && parseInt(props.scorePercent) <=100)
    {
        whatToShow = <>
        <h3>Game Over</h3>
    ...
    else if(parseInt(props.scorePercent) >=50 && parseInt(props.scorePercent) <=80)
    {
        whatToShow = <>
        <h3>Game Over</h3>
        <h4>Score: {props.score}</h4>
    ...
    else if(parseInt(props.scorePercent) >=30 && parseInt(props.scorePercent) <=50)
    {
        whatToShow = <>
        <h3>Game Over</h3>
        <h4>Score: {props.score}</h4>
    ...
    else if(parseInt(props.scorePercent) === 0)
    {
        whatToShow = <>
        <h3>Game Over</h3>
        <h4>Score: {props.score}</h4>
